...
public class GestorePersistenza {
	...
	private static final String FILE_CONFIGURATORI = "../Progetto_ISW_V1/src/dati/configuratori.json";
	private static final String FILE_GERARCHIE = "../Progetto_ISW_V1/src/dati/gerarchie.json";
	private static final String FILE_COMPRENSORI = "../Progetto_ISW_V1/src/dati/comprensori.json";
	private static final String FILE_FATT_CONVERSIONE = "../Progetto_ISW_V1/src/dati/fattConversione.json";
	private static final String FILE_CATEGORIEFOGLIA = "../Progetto_ISW_V1/src/dati/categorieFoglia.json";
